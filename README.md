...
El usuario debe imitar los patrones visuales en su pad o tambor de práctica, trabajando de forma simultánea la lectura rítmica, la coordinación motriz y la concentración.

 > Modos de entrenamiento >>>>>>>


PATRÓN /	Permite escribir secuencias personalizadas usando I (izquierda) y D (derecha). Ideal para practicar ejercicios específicos indicados por un profesor o para repetir estructuras rítmicas.

ALEATORIO / 	Genera figuras de manera aleatoria con duración de dos tiempos. Entrena la reacción y la capacidad de respuesta ante estímulos inesperados.
...
> Controles
 ...
 Patrón personalizable – Escribe y aplica tus propias secuencias rítmicas.
 Presets rápidos – Alt, Bin, 3:3, Sínc para comenzar rápidamente.
